import { JobPosting, PopulatedCompany, ATSPipelineConfig } from 'src/domain/entities/job-posting.entity';
import { JobPostingDocument } from 'src/infrastructure/persistence/mongodb/models/job-posting.model';
